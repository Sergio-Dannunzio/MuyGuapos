...
const RELATED = [
  { slug: 'traje-clasico', name: 'Traje Clásico de Vestir', price: 'ARS 356.800', brand: 'MuyGuapos', img: imgTraje,       colors: [{ hex: '#1a1a1a' }, { hex: '#101453' }, { hex: '#7a7978' }], extra: 2 },
  { slug: 'saco-sport',    name: 'Saco Sport Estructurado', price: 'ARS 198.500', brand: 'MuyGuapos', img: imgSaco,        colors: [{ hex: '#3b2e1e' }, { hex: '#4a4948' }],                     extra: 4 },
  { slug: 'saco-chaleco',  name: 'Saco con Chaleco',        price: 'ARS 274.000', brand: 'MuyGuapos', img: imgSacoChaleco, colors: [{ hex: '#1a1a1a' }, { hex: '#d4b896' }, { hex: '#101453' }], extra: 3 },
  { slug: 'short-bano',    name: 'Short de Baño Premium',   price: 'ARS 54.900',  brand: 'MuyGuapos', img: imgShortBano,   colors: [{ hex: '#1a1a1a' }, { hex: '#101453' }],                     extra: 5 },
]
...
const MOCK_PRODUCT = {
  ...
  colors: [
    { label: 'Negro',  value: 'negro',  hex: '#1a1a1a', img: imgCamisa   },
    { label: 'Beige',  value: 'beige',  hex: '#d4b896', img: imgCamisa01 },
    { label: 'Blanco', value: 'blanco', hex: '#f0ece5', img: imgCamisa02 },
  ],
...
export default function ProductDetailPage() {
  ...
  /* ── Bloque de info compartido (mobile + desktop) ── */
  function InfoPanel({ mobile = false }) {
    return (
      <div style={{ padding: mobile ? '24px 20px 40px' : '48px 48px 64px', borderLeft: mobile ? 'none' : '1px solid var(--color-outline-variant)', minHeight: mobile ? 'auto' : 'calc(100vh - 80px)' }}>
        ...
        {/* Tag */}
        <p style={{ fontFamily: 'var(--font-hanken)', fontSize: '11px', fontWeight: '600', letterSpacing: '0.15em', textTransform: 'uppercase', color: '#101453', margin: '0 0 6px 0' }}>
          {product.tag}
        </p>
              ...
              return (
                <button
                  ...
                  style={{
                    ...
                    backgroundColor: active ? '#101453' : 'transparent',
                    border: active ? '1px solid #101453' : '1px solid var(--color-outline-variant)',
        ...
        <button
          ...
          style={{
            ...
            backgroundColor: !selectedSize ? 'var(--color-outline-variant)' : added ? '#1a5c1a' : '#101453',
        ...
        <button
          ...
          style={{
            ...
            color: wished ? '#e9c349' : 'var(--color-on-surface)',
        ...
        <div className="block md:hidden">
          ...
          >
            ...
            <div style={{ position: 'absolute', top: '50%', left: 0, right: 0, transform: 'translateY(-50%)', display: 'flex', justifyContent: 'space-between', padding: '0 12px', pointerEvents: 'none' }}>
              ...
              >
                <span className="material-symbols-outlined" style={{ fontSize: '20px', color: '#101453' }}>chevron_left</span>
              </button>
              <button
                ...
                style={{
                  width: '36px', height: '36px', borderRadius: '50%',
                  backgroundColor: 'rgba(255,255,255,0.85)',
                  border: 'none', cursor: activeIndex === allImages.length - 1 ? 'default' : 'pointer',
                  display: 'flex', alignItems: 'center', justifyContent: 'center',
                  opacity: activeIndex === allImages.length - 1 ? 0.3 : 1,
                  transition: 'opacity 0.2s',
                  pointerEvents: 'auto',
                  boxShadow: '0 2px 8px rgba(0,0,0,0.15)',
                }}
              >
                <span className="material-symbols-outlined" style={{ fontSize: '20px', color: '#101453' }}>chevron_right</span>
              </button>
            </div>
          </div>
            ...
            {allImages.map((_, i) => (
              <button
                ...
                style={{
                  ...
                  backgroundColor: i === activeIndex ? '#101453' : 'var(--color-outline-variant)',
              ...
              {allImages.map((img, i) => (
                <button
                  ...
                  style={{
                    ...
                    border: activeIndex === i ? '2px solid #101453' : '2px solid transparent',
                    outline: '1px solid var(--color-outline-variant)',
...
function RelatedCard({ item }) {
  ...
  return (
    <Link to="/producto/camisa" style={{ textDecoration: 'none', display: 'block' }} onMouseEnter={() => setHovered(true)} onMouseLeave={() => setHovered(false)}>
