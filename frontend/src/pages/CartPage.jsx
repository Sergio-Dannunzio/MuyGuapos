...
export default function CartPage() {
  ...
  const emptyState = (
    <div style={{ padding: '64px 0', textAlign: 'center' }}>
      ...
      <Link to="/shop" style={{ display: 'inline-block', backgroundColor: '#101453', color: '#fff', fontFamily: 'var(--font-hanken)', fontSize: '13px', fontWeight: '600', letterSpacing: '0.1em', textTransform: 'uppercase', padding: '14px 32px', textDecoration: 'none' }}>
        Ir a la tienda
      </Link>
    </div>
  )
